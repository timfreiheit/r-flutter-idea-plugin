...
import de.timfreiheit.r_flutter.inspections.quickfix.CreateStringResourceQuickFix
    ...
    override fun checkFile(file: PsiFile, manager: InspectionManager, isOnTheFly: Boolean): Array<ProblemDescriptor>? {
        if (file.fileType == DartFileType.INSTANCE) {
            ...
            val errors = analysisService.filter {
                it.code == "undefined_getter" && it.message.contains("defined for the class 'I18n'.")
            }
